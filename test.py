...
def get_matrix_from_query(query_path, event_name, stats_dir):
    ...
    np.savetxt(os.path.join(stats_dir, event_name + '_key_importance.txt'), key_importance)
    np.savetxt(os.path.join(stats_dir, event_name + '_key_concept_similarity.txt'), key_concept_similarity)
...
def main():
    ...
    for event in event_files:
        ...
        get_matrix_from_query(event_path, event, stats_dir)
